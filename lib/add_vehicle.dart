      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: StreamBuilder<DocumentSnapshot>(
            stream: FirebaseFirestore.instance.collection("vehicles").doc("vehicletypes").snapshots(),
            builder: (context, snapshot) {
              ...
              List banner=dataMap.keys.toList();
              return Column(
                    ...
                    child: InkWell(
                      onTap: () {
                        ...
                        name_controller.text!=""&&
                          ...
                          FirebaseFirestore.instance.collection("users").doc(currentuserid).update({
                            "vehicle":FieldValue.arrayUnion([{
                              "vehicletype":dropdown,"model":dropdown1,"Register_no.":regnumber_controller.text,"client_name":name_controller.text
                            }])
                          });
                          print("@@@@@@@@@@@@@@@$currentuserid");
                              ...
                              return Container(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text("Vehicle Added",textAlign: TextAlign.center,style:
                                    TextStyle(
                                      fontSize: width*0.08,
                                      fontWeight: FontWeight.w700,
                                      color: colorPage.primerycolor,
                        ...
                        Future.delayed(Duration(seconds: 1)).then((value) => Navigator.push(context, MaterialPageRoute(builder: (context) => navigationPage(),)));
                          ...
                          dropdown==null?ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("choose your vehicle type"))):
                          dropdown1==null?ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("choose your vehicle model"))):
